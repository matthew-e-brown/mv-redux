...
export function mult(u: AnyVector | AnyMatrix | number, v: AnyVector | AnyMatrix | number): AnyVector | AnyMatrix {
    if (isMatrix(u) && isMatrix(v)) {
        if (u.type === 'mat4' && v.type === 'mat4') {
            return mat4(
            /* col 0 ------------------------------------------------------------------------------------------- */
                /* [0][0] */ (u[0][0] * v[0][0]) + (u[1][0] * v[0][1]) + (u[2][0] * v[0][2]) + (u[3][0] * v[0][3]),
                /* [0][1] */ (u[0][1] * v[0][0]) + (u[1][1] * v[0][1]) + (u[2][1] * v[0][2]) + (u[3][1] * v[0][3]),
                /* [0][2] */ (u[0][2] * v[0][0]) + (u[1][2] * v[0][1]) + (u[2][2] * v[0][2]) + (u[3][2] * v[0][3]),
                /* [0][3] */ (u[0][3] * v[0][0]) + (u[1][3] * v[0][1]) + (u[2][3] * v[0][2]) + (u[3][3] * v[0][3]),
            /* col 1 ------------------------------------------------------------------------------------------- */
                /* [1][0] */ (u[0][0] * v[1][0]) + (u[1][0] * v[1][1]) + (u[2][0] * v[1][2]) + (u[3][0] * v[1][3]),
                /* [1][1] */ (u[0][1] * v[1][0]) + (u[1][1] * v[1][1]) + (u[2][1] * v[1][2]) + (u[3][1] * v[1][3]),
                /* [1][2] */ (u[0][2] * v[1][0]) + (u[1][2] * v[1][1]) + (u[2][2] * v[1][2]) + (u[3][2] * v[1][3]),
                /* [1][3] */ (u[0][3] * v[1][0]) + (u[1][3] * v[1][1]) + (u[2][3] * v[1][2]) + (u[3][3] * v[1][3]),
            /* col 2 ------------------------------------------------------------------------------------------- */
                /* [2][0] */ (u[0][0] * v[2][0]) + (u[1][0] * v[2][1]) + (u[2][0] * v[2][2]) + (u[3][0] * v[2][3]),
                /* [2][1] */ (u[0][1] * v[2][0]) + (u[1][1] * v[2][1]) + (u[2][1] * v[2][2]) + (u[3][1] * v[2][3]),
                /* [2][2] */ (u[0][2] * v[2][0]) + (u[1][2] * v[2][1]) + (u[2][2] * v[2][2]) + (u[3][2] * v[2][3]),
                /* [2][3] */ (u[0][3] * v[2][0]) + (u[1][3] * v[2][1]) + (u[2][3] * v[2][2]) + (u[3][3] * v[2][3]),
            /* col 3 ------------------------------------------------------------------------------------------- */
                /* [3][0] */ (u[0][0] * v[3][0]) + (u[1][0] * v[3][1]) + (u[2][0] * v[3][2]) + (u[3][0] * v[3][3]),
                /* [3][1] */ (u[0][1] * v[3][0]) + (u[1][1] * v[3][1]) + (u[2][1] * v[3][2]) + (u[3][1] * v[3][3]),
                /* [3][2] */ (u[0][2] * v[3][0]) + (u[1][2] * v[3][1]) + (u[2][2] * v[3][2]) + (u[3][2] * v[3][3]),
                /* [3][3] */ (u[0][3] * v[3][0]) + (u[1][3] * v[3][1]) + (u[2][3] * v[3][2]) + (u[3][3] * v[3][3]),
            );
        }
            ...
            return mat3(
            /* col 0 --------------------------------------------------------------------- */
                /* [0][0] */ (u[0][0] * v[0][0]) + (u[1][0] * v[0][1]) + (u[2][0] * v[0][2]),
                /* [0][1] */ (u[0][1] * v[0][0]) + (u[1][1] * v[0][1]) + (u[2][1] * v[0][2]),
                /* [0][2] */ (u[0][2] * v[0][0]) + (u[1][2] * v[0][1]) + (u[2][2] * v[0][2]),
            /* col 1 --------------------------------------------------------------------- */
                /* [1][0] */ (u[0][0] * v[1][0]) + (u[1][0] * v[1][1]) + (u[2][0] * v[1][2]),
                /* [1][1] */ (u[0][1] * v[1][0]) + (u[1][1] * v[1][1]) + (u[2][1] * v[1][2]),
                /* [1][2] */ (u[1][2] * v[1][0]) + (u[1][2] * v[1][1]) + (u[2][2] * v[1][2]),
            /* col 2 --------------------------------------------------------------------- */
                /* [2][0] */ (u[0][0] * v[2][0]) + (u[1][0] * v[2][1]) + (u[2][0] * v[2][2]),
                /* [2][1] */ (u[0][1] * v[2][0]) + (u[1][1] * v[2][1]) + (u[2][1] * v[2][2]),
                /* [2][2] */ (u[0][2] * v[2][0]) + (u[1][2] * v[2][1]) + (u[2][2] * v[2][2]),
            );
        }
            ...
            return mat2(
            /* col 0 ----------------------------------------------- */
                /* [0][0] */ (u[0][0] * v[0][0]) + (u[1][0] * v[0][1]),
                /* [0][1] */ (u[0][1] * v[0][0]) + (u[1][1] * v[0][1]),
            /* col 1 ----------------------------------------------- */
                /* [1][0] */ (u[0][0] * v[1][0]) + (u[1][0] * v[1][1]),
                /* [1][1] */ (u[0][1] * v[1][0]) + (u[1][1] * v[1][1]),
            );
        }
    }
